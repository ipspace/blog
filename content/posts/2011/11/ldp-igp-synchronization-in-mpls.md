...
{{<figure src="/2011/11/s1600-LDPIGP_Backup.png" caption="Packet forwarding across a backup path">}}
...
{{<figure src="/2011/11/s1600-LDPIGP_Restore.png" caption="Labeled packets are dropped on link restoration">}}
...
{{<figure src="/2011/11/s1600-LDPIGP_Targeted.png" caption="Targeted LDP hellos can preserve an LDP session">}}
...
If you need a bit more in-depth details, [buy one of the MPLS books](/2007/06/using-mpls-vpn-books-to-study-for-ccip/) (unfortunately none of my books covers the new features like LDP session protection).
