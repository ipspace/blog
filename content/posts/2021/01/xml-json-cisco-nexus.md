...
---
Last week I [wrote about the interesting challenges you might encounter when using data generated by a Junos device in an Ansible playbook](/2021/01/beware-xml-json-information-loss/). Unfortunately it's not just Junos -- every system built around XML-based data structures might experience the same issues, including Cisco Nexus OS.
