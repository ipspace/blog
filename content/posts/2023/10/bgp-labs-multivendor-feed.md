...
---
A quick update [BGP Labs project](https://bgplab.github.io/bgplab/) status update: now that [netlab release 1.6.4](/2023/10/netlab-1-6-4-more-bgp-nerd-knobs.html) is out I could remove the dependency on using Cumulus Linux as the external BGP router.
...
For more details read the updated [BGP Labs Software Installation and Lab Setup](https://bgplab.github.io/bgplab/1-setup/) guide.
