...
tags: [ BGP, security ]
---
In 2022, I was invited to speak about Internet routing security at the [DEEP conference](https://deep-conference.com/) in Zadar, Croatia. One of the main messages of the presentation was how slow the progress had been even though we had had all the tools available for at least a decade ([RFC 7454](https://datatracker.ietf.org/doc/html/rfc7454) was [finally published in 2015](/2015/02/rfc-7454-bgp-operations-and-security/), and we [started writing it in early 2012](/2012/03/my-first-internet-draft-has-just-been/)).
