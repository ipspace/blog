...
-   Obviously this feature works only over point-to-point interface. You'd need something like [dynamic BGP neighbors from Cisco IOS](/2014/03/scaling-bgp-based-dmvpn-networks.html) for multi-access (example: mGRE) scenarios.
...
**Disclosure**: Cumulus Networks was indirectly covering some of the costs of my attendance at the Network Field Day 9 event. [More...](/p/networking-tech-field-day-disclaimer.html)
