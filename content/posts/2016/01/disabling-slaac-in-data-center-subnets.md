...
<!--more-->
The crucial question is: can you turn off [*autoconfiguration* flag](/2012/11/ipv6-router-advertisements-deep-dive.html) in individual prefixes advertised in RA messages? As always, the answer is *it depends*.
...
As always, there's an alternative: [disable RA processing on Windows servers](http://www.excaliburtech.net/archives/192), and use static default routing and [IPv6 VRRP](/2012/12/do-we-need-fhrp-hsrp-or-vrrp-for-ipv6.html). Welcome back to the 90s.
